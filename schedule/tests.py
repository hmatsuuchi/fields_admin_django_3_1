...
class EventChoicesViewAsUnauthenticatedUserTests(TestCase):
    def setUp(self):
        # create test client
        self.client = APIClient()
...
# ======= Remove Student from Evnet View Tests =======
# ------- tests access permissions -------

# users NOT logged in CANNOT access the remove student from event view
class RemoveStudentFromEventViewAsUnauthenticatedUserTests(TestCase):
    def setUp(self):
        # create test client
        self.client = APIClient()
